...
<%@page import="controlador.compra"%>
            ...
            <div id="header">
                ...
                <div id="menubar" style="background-color:#ff6666">
                    <ul id="menu">
                        ...
                        <li class="current"  ><a href="compra.jsp">Buy</a></li>
                ...
                <div id="content" style="background-color:#ffff33">
                    ...
                    <form action="compra" method="post">
                        <div class="form_settings">
                            ...
                            <p><span>Proveedor</span>
                                <input class="contact" type="text" name="proveedor" value="" /></p>
                            ...
                            <p style="padding-top: 15px"><span>&nbsp;</span><input class="submit" type="submit" name="Compra_registrada" value="Compra" /></p>
                        </div>
                    </form>
