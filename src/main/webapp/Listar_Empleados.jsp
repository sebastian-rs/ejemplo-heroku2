...
<%@page import="Dao.Crud_Empleados"%>
            ...
            <div id="header">
                ...
                <div id="menubar" style="background-color:#ff6666">
                    <ul id="menu">
                        ...
                        <li class="current" ><a href="listar.jsp">List</a></li>
                            ...
                            <%                                System.out.println("lectura");
                                ...
                                List<Empleado> activos = s1.findAll();
                                 ...
                                 for (int i = 0; i < activos.size(); i++) {
                                    ...
                                    out.println("<h1> Cedula :" + activos.get(i).getCedula() + "</h1>");
                                    out.println("<h1> Edad :" + activos.get(i).getEdad() + "</h1>");
                                    out.println("<h1> Estado civil :" + activos.get(i).getEstado_civil() + "</h1>");
                                    out.println("<h1> Direcion :" + activos.get(i).getDireccion() + "</h1>");
                                    out.println("<h1> Telefono :" + activos.get(i).getTelefono() + "</h1>");
                                    out.println("<h1> Eps :" + activos.get(i).getEps() + "</h1>");
                                    out.println("<h1> Fecha de ingreso :" + activos.get(i).getFecha_de_contratacion() + "</h1>");
                                    out.println("<h1>" + "-----------------------------------------------" + "</h1>");
