            ...
            <div id="header">
                ...
                <div id="menubar" style="background-color:#ff6666">
                    <ul id="menu">
                        ...
                        <li  class="current" ><a href="caja.jsp">Caja</a></li>
                ...
                <div id="content" style="background-color:#ffff33">
                    ...
                    <form action="caja" method="post">
                        <div class="form_settings">
                            ...
                            <h1>Dinero disponible en Caja</h1>
                            ...
                            <%                             
                                ...
                                Crud_Compras s3 = new Crud_Compras();
                                List<compras> activos2 = s3.findAll();
                                long tc = 0;
                            ...
                            <h1>Dinero Obtenido en Ventas</h1>
                            ...
                            <%                 
                                ...
                                for (int i = 0; i < activos1.size(); i++) {
                                    String temp2 = activos1.get(i).getValor_total();
                                    String cadenaf = null;
                                    cadenaf = temp2.replaceAll("\\s", "");
                                    int temp = Integer.parseInt(cadenaf);
                                    tv1 = tv1 + temp;
                            ...
                            <%               
                                ...
                                for (int i = 0; i < activos21.size(); i++) {
                                    String temp2 = activos21.get(i).getValor_total();
                                    String cadenaf = null;
                                    cadenaf = temp2.replaceAll("\\s", "");
                                    int temp = Integer.parseInt(cadenaf);
                                    tc11 = tc11 + temp;
